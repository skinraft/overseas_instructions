...
package com.sl.tagmic.xca.zxing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = AppContext.metrics.widthPixels*2/3;
	private static final int MIN_FRAME_HEIGHT = AppContext.metrics.widthPixels*2/3;
