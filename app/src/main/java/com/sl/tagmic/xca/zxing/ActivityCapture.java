...
import com.sl.tagmic.xca.zxing.camera.CameraManager;
import com.sl.tagmic.xca.zxing.decoding.CaptureActivityHandler;
import com.sl.tagmic.xca.zxing.decoding.InactivityTimer;
import com.sl.tagmic.xca.zxing.view.RGBLuminanceSource;
import com.sl.tagmic.xca.zxing.view.ViewfinderView;
 ...
 * </ol>
 */
public class ActivityCapture extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 返回按钮
		back = (ImageView) findViewById(R.id.iv_head_left);
	...
	private void onResultHandler(String resultString, Bitmap bitmap) {
		...
		if (Build.VERSION.SDK_INT >= 21) {
			startActivity(new Intent(ActivityCapture.this, XWebActivity.class).putExtra("code",resultString).putExtra("swich",true));
		} else {
			startActivity(new Intent(ActivityCapture.this, XWebActivity.class).putExtra("code",resultString).putExtra("swich",true));
		}
